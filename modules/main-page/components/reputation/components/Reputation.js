    ...
    return (
        <section className="section reputation">
            ...
            <div className="reputation__wrapper container" id="reputation-wrapper">
                ...
                <div className="reputation__circle"><Image src={circle} alt="" /></div>
                <div className="reputation__images" ref={imagesWrapper}>
                    {
                        images.map((item, index) => {
                            return(
                                <SlideIn key={index} className="reputation__image" opacity={1} delay={index / 10} trigger={imagesWrapper.current}>
                                    <Image
